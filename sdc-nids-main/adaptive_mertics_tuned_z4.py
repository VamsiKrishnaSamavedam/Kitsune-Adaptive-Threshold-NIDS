...
packet_df.to_csv("adaptive_model_packet_metrics_tuned_z4.csv", index=False)

# -------------------------
# Save summary metrics
# -------------------------
summary_df = pd.DataFrame([summary])
summary_df.to_csv("adaptive_model_summary_metrics_tuned_z4.csv", index=False)
...
print("\nSaved files:")
print(" - adaptive_model_packet_metrics_tuned_z4.csv")
print(" - adaptive_model_summary_metrics_tuned_z4.csv")